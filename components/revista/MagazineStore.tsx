  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 md:px-6 md:py-14">
      ...
      <header className="mb-8 md:mb-10">
        ...
        <h1 className="mt-2 text-[34px] font-black leading-[1.05] tracking-tight text-zinc-900 md:text-[46px] dark:text-white">
          Edições digitais
      ...
      <div className="mb-8 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div className="relative w-full md:max-w-xs">
          ...
          <input
            ...
            className="w-full rounded-full border border-black/10 bg-white py-2.5 pl-10 pr-4 text-[14px] text-zinc-900 outline-none transition focus:border-[#6D28D9] dark:border-white/10 dark:bg-zinc-900 dark:text-white"
          />
        </div>
      ...
      {/* Grade */}
      {results.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-black/10 py-20 text-center dark:border-white/10">
          <BookOpen size={40} className="text-zinc-300" />
          <p className="mt-4 text-[15px] font-semibold text-zinc-500 dark:text-zinc-400">
