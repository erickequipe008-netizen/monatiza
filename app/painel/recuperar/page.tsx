          ...
          <form onSubmit={handleSend} className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="h-13 w-full rounded-2xl border border-white/10 bg-white/[0.04] pl-12 pr-4 text-sm text-white placeholder:text-zinc-500 outline-none transition focus:border-[#1d9bf0] focus:bg-white/[0.06] focus:ring-2 focus:ring-[#1d9bf0]/20"
              />
            </div>
