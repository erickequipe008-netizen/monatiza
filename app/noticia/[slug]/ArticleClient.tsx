...
export default function ArticleClient({
  ...
  const authorName =
    rawAuthor && !String(rawAuthor).includes("@") ? rawAuthor : "Redação Monatiza";

  const shareUrl = `https://www.monatiza.com/noticia/${article.slug}`;
    ...
    <div className="bg-white text-black min-h-screen">
      ...
      <div className="max-w-[1180px] mx-auto px-4 py-8 md:py-12 grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-10 lg:gap-16 items-start">
        ...
        <article>
          ...
          <div className="mt-10 pt-6 border-t border-zinc-100 flex items-center gap-3 flex-wrap">
            <span className="text-[12px] font-bold uppercase tracking-wider text-zinc-400 mr-1">
              Compartilhar
            </span>
        ...
        {/* ── SIDEBAR: Leia também + anúncio ── */}
        <aside className="lg:sticky lg:top-[56px] space-y-8">
          <div>
      ...
      <style>{`
        ...
        .article-body h2 {
          ...
          color: #0a0a0a; margin: 2em 0 0.75em; font-family: Georgia, serif;
        }
        .article-body h3 {
          font-size: 20px; font-weight: 700; line-height: 1.3;
          color: #111; margin: 1.75em 0 0.6em; font-family: Georgia, serif;
        }
        .article-body blockquote {
          border-left: 3px solid #dc2626; padding-left: 1.25rem; margin: 2em 0;
          color: #444; font-style: italic; font-size: 19px;
        }
        .article-body a {
          color: #dc2626; text-decoration: underline; text-underline-offset: 3px;
        }
        ...
        .article-body figcaption {
          ...
          margin-top: 0.5em; font-family: system-ui, sans-serif;
        }
